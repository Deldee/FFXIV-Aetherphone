...
internal static class NotificationToggleButton
{
    public static bool Draw(Rect content, float scale, string anchorKey, bool paused, Vector4 accent,
        ...
        FontAwesomeIcon activeIcon = FontAwesomeIcon.Bell, FontAwesomeIcon pausedIcon = FontAwesomeIcon.BellSlash)
    {
        ...
        ProgressRing.CenterIcon(ImGui.GetWindowDrawList(), center, paused ? pausedIcon : activeIcon, color,
            15f * scale);
